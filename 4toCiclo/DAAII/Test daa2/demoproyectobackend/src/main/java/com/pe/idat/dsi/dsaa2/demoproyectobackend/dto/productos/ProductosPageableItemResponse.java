...
@Data
@AllArgsConstructor
public class ProductosPageableItemResponse {
    ...
    public static ProductosPageableItemResponse toProductosPageableItemResponse(Productos productos){
        return new ProductosPageableItemResponse(
