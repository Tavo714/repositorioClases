...
@Data
@AllArgsConstructor
public class ServiciosUpdateResponse {
    private Long servicioId;
    private String nombreServicio;
    private String descripcion;
    private double precio;
    private String estado; 
    public static ServiciosUpdateResponse toServiciosUpdateResponse(Servicios servicios) {
        return new ServiciosUpdateResponse(
